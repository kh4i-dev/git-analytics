...
Engineering Reports are immutable snapshots of repository analytics at a point in time. They combine release notes, changelog, risk insights, and summary context into one canonical report object. Reports are the core distribution mechanism in Phase 1, shareable via capability URL.
...
### Report Object
- Belongs to exactly one Repository (Phase 1)
...
- Non-indexed (`noindex, nofollow`)
- Non-expiring by default
- Phase 1 — no password or passcode
...
- Password/shared-secret public reports
- Expiring public links
- Allowed email/domain access
- Signed invite links
- Multi-repo reports
